...
| `Dallas (us-south)`    | `api.private.us-south.logging.cloud.ibm.com` | 166.9.61.79     166.9.85.89     166.9.90.41  | TCP 443   TCP 80 |
| `Frankfurt (eu-de)`    | `api.private.eu-de.logging.cloud.ibm.com`    | 166.9.28.159    166.9.30.45     166.9.32.117 | TCP 443   TCP 80 |
| `London (eu-gb)`       | `api.private.eu-gb.logging.cloud.ibm.com`    | 166.9.34.79     166.9.36.105    166.9.38.84  | TCP 443   TCP 80 |
| `Osaka (jp-osa)`       | `api.private.jp-osa.logging.cloud.ibm.com`   | 166.9.70.13     166.9.71.14     166.9.72.13  | TCP 443   TCP 80 |
| `Sao Paulo (br-sao)`   | `api.private.br-sao.logging.cloud.ibm.com`   | 166.9.82.12     166.9.83.12     166.9.84.12  | TCP 443   TCP 80 |
| `Sydney (au-syd)`      | `api.private.au-syd.logging.cloud.ibm.com`   | 166.9.52.82     166.9.54.129    166.9.56.79  | TCP 443   TCP 80 |
| `Tokyo (jp-tok)`       | `api.private.jp-tok.logging.cloud.ibm.com`   | 166.9.40.13     166.9.42.72     166.9.44.76  | TCP 443   TCP 80 |
| `Toronto (ca-tor)`     | `api.private.ca-tor.logging.cloud.ibm.com`   | 166.9.76.10     166.9.77.10     166.9.78.10  | TCP 443   TCP 80 |
| `Washington (us-east)` | `api.private.us-east.logging.cloud.ibm.com`  | 166.9.22.194    166.9.24.171    166.9.68.157 | TCP 443   TCP 80 |
...
| `Dallas (us-south)`    | `logs.us-south.logging.cloud.ibm.com` | 50.22.151.6     52.117.134.204  67.228.208.253 | TCP 443   TCP 80 |
| `Frankfurt (eu-de)`    | `logs.eu-de.logging.cloud.ibm.com`    | 149.81.169.206  158.177.133.235 161.156.28.220 | TCP 443   TCP 80 |
| `London (eu-gb)`       | `logs.eu-gb.logging.cloud.ibm.com`    | 141.125.86.131  158.175.91.91   158.176.142.2  | TCP 443   TCP 80 |
| `Osaka (jp-osa)`       | `logs.jp-osa.logging.cloud.ibm.com`   | 163.68.75.68    163.69.70.155   163.73.70.118  | TCP 443   TCP 80 |
| `Sao Paulo (br-sao)`   | `logs.br-sao.logging.cloud.ibm.com`   | 163.107.67.3    163.107.68.196  163.109.68.98  | TCP 443   TCP 80 |
| `Sydney (au-syd)`      | `logs.au-syd.logging.cloud.ibm.com`   | 130.198.1.212   135.90.89.221   135.90.92.246  | TCP 443   TCP 80 |
| `Tokyo (jp-tok)`       | `logs.jp-tok.logging.cloud.ibm.com`   | 128.168.96.179  161.202.231.186 165.192.111.36 | TCP 443   TCP 80 |
| `Toronto (ca-tor)`     | `logs.ca-tor.logging.cloud.ibm.com`   | 163.74.65.133   163.75.73.42    169.53.161.75  | TCP 443   TCP 80 |
| `Washington (us-east)` | `logs.us-east.logging.cloud.ibm.com`  | 169.47.134.86   169.60.72.62    169.61.107.10  | TCP 443   TCP 80 |
...
| `Dallas (us-south)`    | `logs.private.us-south.logging.cloud.ibm.com` | 166.9.61.79     166.9.85.89     166.9.90.41  | TCP 443   TCP 80 |
| `Frankfurt (eu-de)`    | `logs.private.eu-de.logging.cloud.ibm.com`    | 166.9.28.159    166.9.30.45     166.9.32.117 | TCP 443   TCP 80 |
| `London (eu-gb)`       | `logs.private.eu-gb.logging.cloud.ibm.com`    | 166.9.34.79     166.9.36.105    166.9.38.84  | TCP 443   TCP 80 |
| `Osaka (jp-osa)`       | `logs.private.jp-osa.logging.cloud.ibm.com`   | 166.9.70.13     166.9.71.14     166.9.72.13  | TCP 443   TCP 80 |
| `Sao Paulo (br-sao)`   | `logs.private.br-sao.logging.cloud.ibm.com`   | 166.9.82.12     166.9.83.12     166.9.84.12  | TCP 443   TCP 80 |
| `Sydney (au-syd)`      | `logs.private.au-syd.logging.cloud.ibm.com`   | 166.9.52.82     166.9.54.129    166.9.56.79  | TCP 443   TCP 80 |
| `Tokyo (jp-tok)`       | `logs.private.jp-tok.logging.cloud.ibm.com`   | 166.9.40.13     166.9.42.72     166.9.44.76  | TCP 443   TCP 80 |
| `Toronto (ca-tor)`     | `logs.private.ca-tor.logging.cloud.ibm.com`   | 166.9.76.10     166.9.77.10     166.9.78.10  | TCP 443   TCP 80 |
| `Washington (us-east)` | `logs.private.us-east.logging.cloud.ibm.com`  | 166.9.22.194    166.9.24.171    166.9.68.157 | TCP 443   TCP 80 |
