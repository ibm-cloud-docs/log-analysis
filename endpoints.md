...
| `Dallas (us-south)`    | `api.us-south.logging.cloud.ibm.com` | 67.228.208.253 \n 52.117.134.204 \n 50.22.151.6     | TCP 443   TCP 80 |
| `Frankfurt (eu-de)`    | `api.eu-de.logging.cloud.ibm.com`    | 158.177.133.235 \n 149.81.169.206 \n 161.156.28.220 | TCP 443   TCP 80 |
| `London (eu-gb)`       | `api.eu-gb.logging.cloud.ibm.com`    | 158.175.91.91 \n 158.176.142.2 \n 141.125.86.131    | TCP 443   TCP 80 |
| `Osaka (jp-osa)`       | `api.jp-osa.logging.cloud.ibm.com`   | 163.68.75.68 \n 163.69.70.155 \n 163.73.70.118      | TCP 443   TCP 80 |
| `Sao Paulo (br-sao)`   | `api.br-sao.logging.cloud.ibm.com`   | 163.107.68.196 \n 163.109.68.98 \n 163.107.67.3     | TCP 443   TCP 80 |
| `Sydney (au-syd)`      | `api.au-syd.logging.cloud.ibm.com`   | 135.90.89.221 \n 135.90.92.246 \n 130.198.1.212     | TCP 443   TCP 80 |
| `Tokyo (jp-tok)`       | `api.jp-tok.logging.cloud.ibm.com`   | 165.192.111.36 \n 128.168.96.179 \n 161.202.231.186 | TCP 443   TCP 80 |
| `Toronto (ca-tor)`     | `api.ca-tor.logging.cloud.ibm.com`   | 169.53.161.75 \n 163.74.65.133 \n 163.75.73.42      | TCP 443   TCP 80 |
| `Washington (us-east)` | `api.us-east.logging.cloud.ibm.com`  | 169.47.134.86 \n 169.61.107.10 \n 169.60.72.62      | TCP 443   TCP 80 |
...
|------------------------|----------------------------------------------|----------------------------------------------|------------------|
| `Chennai (in-che)`     | `api.private.in-che.logging.cloud.ibm.com`   | 166.9.60.11                                  | TCP 443   TCP 80 |
| `Dallas (us-south)`    | `api.private.us-south.logging.cloud.ibm.com` | 166.9.85.89 \n 166.9.61.79 \n 166.9.90.41    | TCP 443   TCP 80 |
| `Frankfurt (eu-de)`    | `api.private.eu-de.logging.cloud.ibm.com`    | 166.9.30.45 \n 166.9.32.117 \n 166.9.28.159  | TCP 443   TCP 80 |
| `London (eu-gb)`       | `api.private.eu-gb.logging.cloud.ibm.com`    | 166.9.36.105 \n 166.9.34.79 \n 166.9.38.84   | TCP 443   TCP 80 |
| `Osaka (jp-osa)`       | `api.private.jp-osa.logging.cloud.ibm.com`   | 166.9.71.14 \n 166.9.72.13 \n 166.9.70.13    | TCP 443   TCP 80 |
| `Sao Paulo (br-sao)`   | `api.private.br-sao.logging.cloud.ibm.com`   | 166.9.83.12 \n 166.9.84.12 \n 166.9.82.12    | TCP 443   TCP 80 |
| `Sydney (au-syd)`      | `api.private.au-syd.logging.cloud.ibm.com`   | 166.9.52.82 \n 166.9.56.79 \n 166.9.54.129   | TCP 443   TCP 80 |
| `Tokyo (jp-tok)`       | `api.private.jp-tok.logging.cloud.ibm.com`   | 166.9.42.72 \n 166.9.44.76 \n 166.9.40.13    | TCP 443   TCP 80 |
| `Toronto (ca-tor)`     | `api.private.ca-tor.logging.cloud.ibm.com`   | 166.9.77.10 \n 166.9.78.10 \n 166.9.76.10    | TCP 443   TCP 80 |
| `Washington (us-east)` | `api.private.us-east.logging.cloud.ibm.com`  | 166.9.22.194 \n 166.9.68.157 \n 166.9.24.171 | TCP 443   TCP 80 |
...
|------------------------|---------------------------------------|-----------------------------------------------------|------------------|
| `Chennai (in-che)`     | `logs.in-che.logging.cloud.ibm.com`   | 169.38.94.141                                       | TCP 443   TCP 80 |
| `Dallas (us-south)`    | `logs.us-south.logging.cloud.ibm.com` | 67.228.208.253 \n 50.22.151.6 \n 52.117.134.204     | TCP 443   TCP 80 |
| `Frankfurt (eu-de)`    | `logs.eu-de.logging.cloud.ibm.com`    | 149.81.169.206 \n 161.156.28.220 \n 158.177.133.235 | TCP 443   TCP 80 |
| `London (eu-gb)`       | `logs.eu-gb.logging.cloud.ibm.com`    | 158.176.142.2 \n 141.125.86.131 \n 158.175.91.91    | TCP 443   TCP 80 |
| `Osaka (jp-osa)`       | `logs.jp-osa.logging.cloud.ibm.com`   | 163.68.75.68 \n 163.73.70.118 \n 163.69.70.155      | TCP 443   TCP 80 |
| `Sao Paulo (br-sao)`   | `logs.br-sao.logging.cloud.ibm.com`   | 163.107.68.196 \n 163.107.67.3 \n 163.109.68.98     | TCP 443   TCP 80 |
| `Sydney (au-syd)`      | `logs.au-syd.logging.cloud.ibm.com`   | 135.90.92.246 \n 135.90.89.221 \n 130.198.1.212     | TCP 443   TCP 80 |
| `Tokyo (jp-tok)`       | `logs.jp-tok.logging.cloud.ibm.com`   | 165.192.111.36 \n 161.202.231.186 \n 128.168.96.179 | TCP 443   TCP 80 |
| `Toronto (ca-tor)`     | `logs.ca-tor.logging.cloud.ibm.com`   | 163.74.65.133 \n 169.53.161.75 \n 163.75.73.42      | TCP 443   TCP 80 |
| `Washington (us-east)` | `logs.us-east.logging.cloud.ibm.com`  | 169.61.107.10 \n 169.60.72.62 \n 169.47.134.86      | TCP 443   TCP 80 |
...
|------------------------|-----------------------------------------------|----------------------------------------------|------------------|
| `Chennai (in-che)`     | `logs.private.in-che.logging.cloud.ibm.com`   | 166.9.60.11                                  | TCP 443   TCP 80 |
| `Dallas (us-south)`    | `logs.private.us-south.logging.cloud.ibm.com` | 166.9.61.79 \n 166.9.85.89 \n 166.9.90.41    | TCP 443   TCP 80 |
| `Frankfurt (eu-de)`    | `logs.private.eu-de.logging.cloud.ibm.com`    | 166.9.28.159 \n 166.9.30.45 \n 166.9.32.117  | TCP 443   TCP 80 |
| `London (eu-gb)`       | `logs.private.eu-gb.logging.cloud.ibm.com`    | 166.9.34.79 \n 166.9.38.84 \n 166.9.36.105   | TCP 443   TCP 80 |
| `Osaka (jp-osa)`       | `logs.private.jp-osa.logging.cloud.ibm.com`   | 166.9.70.13 \n 166.9.71.14 \n 166.9.72.13    | TCP 443   TCP 80 |
| `Sao Paulo (br-sao)`   | `logs.private.br-sao.logging.cloud.ibm.com`   | 166.9.83.12 \n 166.9.82.12 \n 166.9.84.12    | TCP 443   TCP 80 |
| `Sydney (au-syd)`      | `logs.private.au-syd.logging.cloud.ibm.com`   | 166.9.52.82 \n 166.9.56.79 \n 166.9.54.129   | TCP 443   TCP 80 |
| `Tokyo (jp-tok)`       | `logs.private.jp-tok.logging.cloud.ibm.com`   | 166.9.42.72 \n 166.9.44.76 \n 166.9.40.13    | TCP 443   TCP 80 |
| `Toronto (ca-tor)`     | `logs.private.ca-tor.logging.cloud.ibm.com`   | 166.9.78.10 \n 166.9.76.10 \n 166.9.77.10    | TCP 443   TCP 80 |
| `Washington (us-east)` | `logs.private.us-east.logging.cloud.ibm.com`  | 166.9.68.157 \n 166.9.24.171 \n 166.9.22.194 | TCP 443   TCP 80 |
...
| `Dallas (us-south)`    | `syslog://syslog-a.us-south.logging.cloud.ibm.com` | 52.116.247.170 \n 52.117.134.206 \n 67.228.102.117   |
| `Frankfurt (eu-de)`    | `syslog://syslog-a.eu-de.logging.cloud.ibm.com`    | 158.177.157.70 \n 161.156.78.138 \n 149.81.108.28    |
| `London (eu-gb)`       | `syslog://syslog-a.eu-gb.logging.cloud.ibm.com`    | 158.176.163.115 \n 141.125.102.148 \n 158.175.113.22 |
| `Osaka (jp-osa)`       | `syslog://syslog-a.jp-osa.logging.cloud.ibm.com`   | 163.68.72.220 \n 163.69.67.210 \n 163.73.68.45       |
| `Sao Paulo (br-sao)`   | `syslog://syslog-a.br-sao.logging.cloud.ibm.com`   | 163.107.68.195 \n 169.57.254.118 \n 163.109.68.109   |
| `Sydney (au-syd)`      | `syslog://syslog-a.au-syd.logging.cloud.ibm.com`   | 168.1.202.76 \n 135.90.92.254 \n 130.198.1.210       |
| `Tokyo (jp-tok)`       | `syslog://syslog-a.jp-tok.logging.cloud.ibm.com`   | 161.202.248.162 \n 165.192.100.77 \n 128.168.95.2    |
| `Toronto (ca-tor)`     | `syslog://syslog-a.ca-tor.logging.cloud.ibm.com`   | 163.75.66.13 \n 169.53.186.154 \n 163.74.69.234      |
| `Washington (us-east)` | `syslog://syslog-a.us-east.logging.cloud.ibm.com`  | 169.47.34.203 \n 169.61.98.203 \n 169.60.121.243     |
...
| `Dallas (us-south)`    | `syslog://syslog-u.us-south.logging.cloud.ibm.com` | 67.228.102.116 \n 52.116.247.173 \n 169.60.203.92   |
| `Frankfurt (eu-de)`    | `syslog://syslog-u.eu-de.logging.cloud.ibm.com`    | 149.81.108.30 \n 161.156.78.139 \n 158.177.143.26   |
| `London (eu-gb)`       | `syslog://syslog-u.eu-gb.logging.cloud.ibm.com`    | 141.125.140.98 \n 158.176.163.156 \n 158.175.66.210 |
| `Osaka (jp-osa)`       | `syslog://syslog-u.jp-osa.logging.cloud.ibm.com`   | 163.68.72.219 \n 163.73.68.46 \n 163.69.68.70       |
| `Sao Paulo (br-sao)`   | `syslog://syslog-u.br-sao.logging.cloud.ibm.com`   | 163.109.68.100 \n 163.107.69.14 \n 169.57.152.196   |
| `Sydney (au-syd)`      | `syslog://syslog-u.au-syd.logging.cloud.ibm.com`   | 130.198.71.30 \n 135.90.92.253 \n 168.1.27.59       |
| `Tokyo (jp-tok)`       | `syslog://syslog-u.jp-tok.logging.cloud.ibm.com`   | 169.56.11.252 \n 165.192.100.76 \n 128.168.107.244  |
| `Toronto (ca-tor)`     | `syslog://syslog-u.ca-tor.logging.cloud.ibm.com`   | 169.55.135.29 \n 163.75.66.11 \n 163.74.69.236      |
...
| `Dallas (us-south)`    | `syslog://syslog-a.private.us-south.logging.cloud.ibm.com` | 166.9.12.15 \n 166.9.16.14 \n 166.9.14.5   |
| `Frankfurt (eu-de)`    | `syslog://syslog-a.private.eu-de.logging.cloud.ibm.com`    | 166.9.28.5 \n 166.9.30.236 \n 166.9.32.23  |
| `London (eu-gb)`       | `syslog://syslog-a.private.eu-gb.logging.cloud.ibm.com`    | 166.9.34.18 \n 166.9.38.20 \n 166.9.36.5   |
| `Osaka (jp-osa)`       | `syslog://syslog-a.private.jp-osa.logging.cloud.ibm.com`   | 166.9.72.22 \n 166.9.71.22 \n 166.9.70.22  |
| `Sao Paulo (br-sao)`   | `syslog://syslog-a.private.br-sao.logging.cloud.ibm.com`   | 166.9.82.26 \n 166.9.84.23 \n 166.9.83.22  |
| `Sydney (au-syd)`      | `syslog://syslog-a.private.au-syd.logging.cloud.ibm.com`   | 166.9.52.8 \n 166.9.56.22 \n 166.9.54.124  |
| `Tokyo (jp-tok)`       | `syslog://syslog-a.private.jp-tok.logging.cloud.ibm.com`   | 166.9.40.23 \n 166.9.44.67 \n 166.9.42.26  |
| `Toronto (ca-tor)`     | `syslog://syslog-a.private.ca-tor.logging.cloud.ibm.com`   | 166.9.78.29 \n 166.9.77.28 \n 166.9.76.31  |
| `Washington (us-east)` | `syslog://syslog-a.private.us-east.logging.cloud.ibm.com`  | 166.9.20.76 \n 166.9.22.38 \n 166.9.24.243 |
...
| `Dallas (us-south)`    | `syslog://syslog-u.private.us-south.logging.cloud.ibm.com` | 166.9.12.16 \n 166.9.16.15 \n 166.9.14.6   |
| `Frankfurt (eu-de)`    | `syslog://syslog-u.private.eu-de.logging.cloud.ibm.com`    | 166.9.30.239 \n 166.9.32.24 \n 166.9.28.7  |
| `London (eu-gb)`       | `syslog://syslog-u.private.eu-gb.logging.cloud.ibm.com`    | 166.9.34.19 \n 166.9.38.21 \n 166.9.36.6   |
| `Osaka (jp-osa)`       | `syslog://syslog-u.private.jp-osa.logging.cloud.ibm.com`   | 166.9.70.23 \n 166.9.71.23 \n 166.9.72.23  |
| `Sao Paulo (br-sao)`   | `syslog://syslog-u.private.br-sao.logging.cloud.ibm.com`   | 166.9.82.27 \n 166.9.83.26 \n 166.9.84.26  |
...
| `Toronto (ca-tor)`     | `syslog://syslog-u.private.ca-tor.logging.cloud.ibm.com`   | 166.9.78.30 \n 166.9.76.32 \n 166.9.77.29  |
| `Washington (us-east)` | `syslog://syslog-u.private.us-east.logging.cloud.ibm.com`  | 166.9.24.244 \n 166.9.22.39 \n 166.9.20.77 |
...
| `Dallas (us-south)`    | `syslog-tls://syslog-a.us-south.logging.cloud.ibm.com` | 67.228.102.117 \n 52.117.134.206 \n 52.116.247.170   |
| `Frankfurt (eu-de)`    | `syslog-tls://syslog-a.eu-de.logging.cloud.ibm.com`    | 158.177.157.70 \n 161.156.78.138 \n 149.81.108.28    |
| `London (eu-gb)`       | `syslog-tls://syslog-a.eu-gb.logging.cloud.ibm.com`    | 141.125.102.148 \n 158.175.113.22 \n 158.176.163.115 |
| `Osaka (jp-osa)`       | `syslog-tls://syslog-a.jp-osa.logging.cloud.ibm.com`   | 163.68.72.220 \n 163.69.67.210 \n 163.73.68.45       |
| `Sao Paulo (br-sao)`   | `syslog-tls://syslog-a.br-sao.logging.cloud.ibm.com`   | 163.109.68.109 \n 169.57.254.118 \n 163.107.68.195   |
| `Sydney (au-syd)`      | `syslog-tls://syslog-a.au-syd.logging.cloud.ibm.com`   | 130.198.1.210 \n 168.1.202.76 \n 135.90.92.254       |
| `Tokyo (jp-tok)`       | `syslog-tls://syslog-a.jp-tok.logging.cloud.ibm.com`   | 128.168.95.2 \n 161.202.248.162 \n 165.192.100.77    |
| `Toronto (ca-tor)`     | `syslog-tls://syslog-a.ca-tor.logging.cloud.ibm.com`   | 163.74.69.234 \n 163.75.66.13 \n 169.53.186.154      |
| `Washington (us-east)` | `syslog-tls://syslog-a.us-east.logging.cloud.ibm.com`  | 169.47.34.203 \n 169.61.98.203 \n 169.60.121.243     |
...
| `Dallas (us-south)`    | `syslog-tls://syslog-a.private.us-south.logging.cloud.ibm.com` | 166.9.14.5 \n 166.9.16.14 \n 166.9.12.15   |
| `Frankfurt (eu-de)`    | `syslog-tls://syslog-a.private.eu-de.logging.cloud.ibm.com`    | 166.9.32.23 \n 166.9.30.236 \n 166.9.28.5  |
| `London (eu-gb)`       | `syslog-tls://syslog-a.private.eu-gb.logging.cloud.ibm.com`    | 166.9.36.5 \n 166.9.38.20 \n 166.9.34.18   |
| `Osaka (jp-osa)`       | `syslog-tls://syslog-a.private.jp-osa.logging.cloud.ibm.com`   | 166.9.71.22 \n 166.9.72.22 \n 166.9.70.22  |
| `Sao Paulo (br-sao)`   | `syslog-tls://syslog-a.private.br-sao.logging.cloud.ibm.com`   | 166.9.84.23 \n 166.9.83.22 \n 166.9.82.26  |
| `Sydney (au-syd)`      | `syslog-tls://syslog-a.private.au-syd.logging.cloud.ibm.com`   | 166.9.54.124 \n 166.9.56.22 \n 166.9.52.8  |
| `Tokyo (jp-tok)`       | `syslog-tls://syslog-a.private.jp-tok.logging.cloud.ibm.com`   | 166.9.40.23 \n 166.9.44.67 \n 166.9.42.26  |
| `Toronto (ca-tor)`     | `syslog-tls://syslog-a.private.ca-tor.logging.cloud.ibm.com`   | 166.9.77.28 \n 166.9.76.31 \n 166.9.78.29  |
| `Washington (us-east)` | `syslog-tls://syslog-a.private.us-east.logging.cloud.ibm.com`  | 166.9.24.243 \n 166.9.20.76 \n 166.9.22.38 |
