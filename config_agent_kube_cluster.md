...
au-syd
  https://assets.au-syd.logging.cloud.ibm.com/clients/agent-namespace.yaml
  https://assets.au-syd.logging.cloud.ibm.com/clients/agent-resources.yaml
  https://assets.au-syd.logging.cloud.ibm.com/clients/agent-resources-private.yaml

eu-de
  https://assets.eu-de.logging.cloud.ibm.com/clients/agent-namespace.yaml
  https://assets.eu-de.logging.cloud.ibm.com/clients/agent-resources.yaml
  https://assets.eu-de.logging.cloud.ibm.com/clients/agent-resources-private.yaml
  https://assets.eu-de.logging.cloud.ibm.com/clients/agent-resources-supertenant.yaml
  https://assets.eu-de.logging.cloud.ibm.com/clients/agent-resources-supertenant-private.yaml
eu-gb
  https://assets.eu-gb.logging.cloud.ibm.com/clients/agent-namespace.yaml
  https://assets.eu-gb.logging.cloud.ibm.com/clients/agent-resources.yaml
  https://assets.eu-gb.logging.cloud.ibm.com/clients/agent-resources-private.yaml
  https://assets.eu-gb.logging.cloud.ibm.com/clients/agent-resources-supertenant.yaml
  https://assets.eu-gb.logging.cloud.ibm.com/clients/agent-resources-supertenant-private.yaml
in-che
  https://assets.in-che.logging.cloud.ibm.com/clients/agent-namespace.yaml
  https://assets.in-che.logging.cloud.ibm.com/clients/agent-resources.yaml
  https://assets.in-che.logging.cloud.ibm.com/clients/agent-resources-private.yaml
  https://assets.in-che.logging.cloud.ibm.com/clients/agent-resources-supertenant.yaml
  https://assets.in-che.logging.cloud.ibm.com/clients/agent-resources-supertenant-private.yaml
jp-tok
  https://assets.jp-tok.logging.cloud.ibm.com/clients/agent-namespace.yaml
  https://assets.jp-tok.logging.cloud.ibm.com/clients/agent-resources.yaml
  https://assets.jp-tok.logging.cloud.ibm.com/clients/agent-resources-private.yaml
  https://assets.jp-tok.logging.cloud.ibm.com/clients/agent-resources-supertenant.yaml
  https://assets.jp-tok.logging.cloud.ibm.com/clients/agent-resources-supertenant-private.yaml
kr-seo
  https://assets.kr-seo.logging.cloud.ibm.com/clients/agent-namespace.yaml
  https://assets.kr-seo.logging.cloud.ibm.com/clients/agent-resources.yaml
  https://assets.kr-seo.logging.cloud.ibm.com/clients/agent-resources-private.yaml
  https://assets.kr-seo.logging.cloud.ibm.com/clients/agent-resources-supertenant.yaml
  https://assets.kr-seo.logging.cloud.ibm.com/clients/agent-resources-supertenant-private.yaml
us-east
  https://assets.us-east.logging.cloud.ibm.com/clients/agent-namespace.yaml
  https://assets.us-east.logging.cloud.ibm.com/clients/agent-resources.yaml
  https://assets.us-east.logging.cloud.ibm.com/clients/agent-resources-private.yaml
  https://assets.us-east.logging.cloud.ibm.com/clients/agent-resources-supertenant.yaml
  https://assets.us-east.logging.cloud.ibm.com/clients/agent-resources-supertenant-private.yaml
us-south
  https://assets.us-south.logging.cloud.ibm.com/clients/agent-namespace.yaml
  https://assets.us-south.logging.cloud.ibm.com/clients/agent-resources.yaml
  https://assets.us-south.logging.cloud.ibm.com/clients/agent-resources-private.yaml
  https://assets.us-south.logging.cloud.ibm.com/clients/agent-resources-supertenant.yaml
  https://assets.us-south.logging.cloud.ibm.com/clients/agent-resources-supertenant-private.yaml
