...
You can [configure the logging agent](/docs/Log-Analysis-with-LogDNA?topic=Log-Analysis-with-LogDNA-log_analysis_agent) to use the private network by using a private endpoint as the ingestion URL.
