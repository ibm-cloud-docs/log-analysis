...
{: caption="Predefined devops views" caption-side="bottom"}
...
{: caption="Predefined events views" caption-side="bottom"}
...
{: caption="Predefined ESXi views" caption-side="bottom"}
...
{: caption="Predefined NSX views" caption-side="bottom"}
...
{: caption="Predefined vCenter views" caption-side="bottom"}
...
{: caption="Predefined boards" caption-side="bottom"}

![Sample VMware board](images/vmware-sample-board.png "Sample VMware board"){: caption="Sample VMWare board" caption-side="bottom"}
...
{: caption="Predefined screen" caption-side="bottom"}
