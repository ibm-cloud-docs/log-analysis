...
![Sending logs overview](../images/Log-Analysis-06-VMware-vCenter-Architecture.svg "Sending logs overview"){: caption="Sending logs" caption-side="bottom"}
...
{: caption="Common log files" caption-side="bottom"}
...
{: caption="Log files when mangement node deployment is selected" caption-side="bottom"}
...
{: caption="ESXi host logs" caption-side="bottom"}
...
{: caption="NSX logs" caption-side="bottom"}
...
{: caption="Guest introspection service logs" caption-side="bottom"}
...
2. Select the vCenter Server instance. Then, select **Configure** > **Settings** > **Advanced System Settings**.
    ...
    ![Configure vCenter](../images/vmware-vcenter-settings.png "Configure vCenter"){: caption="Edit Advanced vCenter Server Sttings" caption-side="bottom"}
...
4. Change the value for **Logging options**.
    ...
    {: caption="Logging option values" caption-side="bottom"}
