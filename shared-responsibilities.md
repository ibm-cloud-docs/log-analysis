...
| `Monitor logs collected by LogDNA agents`   | Provide images and instructions for how to install LogDNA agents in environments that you want to monitor, such as Kubernetes, Linux, Openshift. | [Install and configure LogDNA agents.](/docs/Log-Analysis-with-LogDNA?topic=LogDNA-logdna_agent#logdna_agent_connect) </br>Monitor that the agents are running in your environment. |
